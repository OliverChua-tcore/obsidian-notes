...
trxn-cleared: false             # false: pending | true: posted
trxn-cleared-date:              # posted date
trxn-cleared-statement:         # link to statement (PDF)
short-date: "<% trxnDate %>"    # YYYY-MM-DD value used by "date-when-snippet"
